...
public class ApiController {
    ...
    public @ResponseBody ResponseEntity<?> SatelliteData(@RequestParam("satelliteData") String satelliteData){
        ...
        // AGI
        czmlObj = new CzmlObj();
        czmlObj.setId("Facility/AGI");
        czmlObj.setName("AGI");
        czmlObj.setAvailability(new String[]{"2016-03-15T10:00:00Z/2016-10-16T10:00:00Z"});
        czmlObj.setDescription("<!--HTML-->\\r\\n<p>\\r\\nAnalytical Graphics, Inc. (AGI) develops commercial modeling and analysis software used by more than 40,000 global space, defense and intelligence professionals. AGI founded Cesium to meet the need for a cross-platform virtual globe with dynamic-data visualization. AGI continues to invest heavily in Cesium's development and facilitate the growth of the user and contributor community.\\r\\n</p>");
        Billboard billboard = new Billboard();
        czmlObj.setBillboard(billboard);
        billboard.setHorizontalOrigin("CENTER");
        billboard.setImage("data:image/png;base64,");
        billboard.setShow(true);
        Position position = new Position();
        position.setCartesian(fillPosition(1216469.9357990976,-4736121.71856379,4081386.8856866374));
        czmlObj.setPosition(position);
        czmlObjs.add(czmlObj);

        czmlObj = new CzmlObj();
        czmlObj.setId("SATELLITE_1");
        czmlObj.setName("Test Satellite");
        czmlObj.setDescription("Click me");
        czmlObj.setAvailability(new String[]{"2016-03-15T10:00:00Z/2016-10-20T10:00:00Z"});
        ...
        // Interaction
        czmlObj = new CzmlObj();
        czmlObj.setId("AGI-to-ISS");
        czmlObj.setAvailability(new String[]{"2016-03-15T10:52:19.3940000000002Z/2016-06-15T11:02:24.5570000000007Z"});

        PolyLine polyLine = new PolyLine();
        polyLine.setShow(new ShowInterval[]{new ShowInterval("2016-03-15T10:52:19.3940000000002Z/2016-06-15T11:02:24.5570000000007Z", true)});
        polyLine.setFollowSurface(false);
        Positions positions = new Positions();
        positions.setReferences(new String[]{"Facility/AGI#position","SATELLITE_1#position"});
        polyLine.setPositions(positions);
        polyLine.setMaterial(new Material(new SolidColor(new Color(new int[]{0, 255,255,255}))));
        czmlObj.setPolyLine(polyLine);
        czmlObjs.add(czmlObj);
